...
namespace IdentitySample.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult EditarUsuario(string userId)
        {
            ...
            if (nivelDeAcesso.Equals('A'))
            {
                userManager.AddToRole(usuario.Id, "Administrador");
            }
            else if (nivelDeAcesso.Equals('G'))
            {
        ...
        public ActionResult BuscaFuncionario()
        {
            ...
            List<Pessoa> listaDeFuncinarios = FiltroConsulta(valor, filtro);
        ...
        private List<Pessoa> FiltroConsulta(string consulta, string filtro)
        {
            ...
            switch (Convert.ToInt32(filtro))
            {
                ...
                case 1:
                    ...
                    pessoas = IPessoas.ListarPorCpfCnpj(cpf).Where(Pessoa => Pessoa.isFuncionario = true).ToList<Pessoa>();
                    break;

                case 2:
                    string nome = consulta;
                    pessoas = IPessoas.ListarPorNome(nome).Where(Pessoa => Pessoa.isFuncionario = true).ToList<Pessoa>();
                    break;
