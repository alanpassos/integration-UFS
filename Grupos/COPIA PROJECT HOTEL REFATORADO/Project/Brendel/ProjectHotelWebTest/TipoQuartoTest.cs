...
namespace ProjectHotelWebTest
{
    ...
    public class TipoQuartoTest
    {
        ...
        public void CadastrarTipoQuartoValidoTest()
        {
            ...
            newTipoQuarto = new TipoQuartoModel();
            ...
            TipoQuartoModel tipoQuartoCadastrado = gTipoQuartos.ResultadoUnico(newTipoQuarto.idTipoQuarto);
            Assert.IsNotNull(tipoQuartoCadastrado);
            Assert.IsInstanceOfType(tipoQuartoCadastrado, typeof(TipoQuartoModel));
