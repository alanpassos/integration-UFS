--1.Criar um procedimento para calcular o IMPOSTO DE RENDA a ser pago em  função de 
...
--: 15% e 27,5% conforme tabela progressiva mensal abaixo 
--reproduzida: 
...
BEGIN
	SET @PAGAMENTO = @RENDA * 0.15
END
ELSE
BEGIN
	SET @PAGAMENTO = @RENDA * 0.275
END
