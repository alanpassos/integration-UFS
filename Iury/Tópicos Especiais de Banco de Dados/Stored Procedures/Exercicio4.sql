...
DELETE FROM TB_CLIENTE WHERE TB_CLIENTE.MATRICULA = @MATRICULA
...
--Alterar procedure incluir cliente
ALTER PROCEDURE SP_INCLUI_CLIENTE (@MATRICULA INT, @NOME VARCHAR(40), @TELEFONE VARCHAR(40),
									 @MENSAGEM VARCHAR(40) OUTPUT) AS
INSERT INTO TB_CLIENTE 
VALUES (@MATRICULA, @NOME, @TELEFONE)
--@@error é igual a 0 se o comando imediatamente superior foi executado SEM ERROS
IF @@ERROR = 0
  SET @MENSAGEM = 'Cliente inserido com sucesso'
ELSE
  @MENSAGEM = 'Não foi possível inserir cliente'
